...
import com.zysoft.tjawshapingapp.view.im.adapter.EmotionGridViewAdapter;
import com.zysoft.tjawshapingapp.view.im.adapter.EmotionPagerAdapter;
import com.zysoft.tjawshapingapp.view.im.util.EmotionUtils;
...
import com.zysoft.tjawshapingapp.view.im.widget.IndicatorView;
 ...
 * 邮箱：rance935@163.com
 */
public class ChatEmotionFragment extends BaseIMFragment {
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = CustomApplaction.screenWidth;
        // item的间距
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(screenWidth, gvHeight,1);
