package com.zysoft.tjawshapingapp.view.im.util;
...
import com.zysoft.tjawshapingapp.view.im.BaseIMFragment;
...
public class PhotoUtils {
     ...
     */
    public static void takePicture(BaseIMFragment baseFragment, Uri imageUri, int requestCodeCamera) {
