package com.zysoft.tjawshapingapp.view.im.widget;
...
import com.zysoft.tjawshapingapp.view.im.util.AudioRecorderUtils;
import com.zysoft.tjawshapingapp.view.im.util.Constants;
import com.zysoft.tjawshapingapp.view.im.util.PopupWindowFactory;
...
public class EmotionInputDetector {
    ...
    public EmotionInputDetector bindToSendButton(View sendButton) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mAddButton.setVisibility(View.VISIBLE);
                mSendButton.setVisibility(View.GONE);
                MyMessage messageInfo = new MyMessage(mEditText.getText().toString(),IMessage.MessageType.SEND_TEXT.ordinal());
                EventBus.getDefault().post(new NetResponse("SEND_TEXT",messageInfo));
                mEditText.setText("");
            }
        });
        return this;
    ...
    public EmotionInputDetector build() {
        ...
        mAudioRecorderUtils.setOnAudioStatusUpdateListener(new AudioRecorderUtils.OnAudioStatusUpdateListener() {
            ...
            public void onStop(long time, String filePath) {
                //录音
                MyMessage message = new MyMessage("", IMessage.MessageType.SEND_VOICE.ordinal());
                message.setMediaFilePath(filePath);
                message.setDuration(time/1000);
                message.setTimeString(new SimpleDateFormat("HH:mm", Locale.getDefault()).format(new Date()));
                EventBus.getDefault().post(new NetResponse("VOICE",message));
            }
    ...
    private int getSoftButtonsBarHeight() {
        ...
        Log.e("bottombar高度", String.valueOf(realHeight-usableHeight));
